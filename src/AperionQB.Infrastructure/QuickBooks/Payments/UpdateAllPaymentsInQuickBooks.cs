        ...
        public async Task<bool> UpdateAllPaymentsInQB()
        {
            ...
            foreach (QBUpdateTransactions transaction in transactions)
            {
                ...
                try
                {
                    ...
                    {
                        _logger.log(DateTime.Now + ": Payment with QBPayment ID: " + transaction.QBPaymentsID + " hasn't been pushed to intuit yet. Please check to make sure a valid Customer Mapping is available. Skipping update....");
                    }
